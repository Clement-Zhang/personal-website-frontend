...
export const programs = {
    beam: 'left-[53.25%] top-[3.37%]',
    'ice wall': 'left-[14.72%] top-[23.15%]',
    shuriken: 'left-[39.87%] top-[23.15%]',
    'data leech': 'left-[66.1%] top-[23.01%]',
    protector: 'left-[14.54%] top-[43.14%]',
    blaster: 'left-[40.05%] top-[43.14%]',
    worm: 'left-[66.37%] top-[43.28%]',
    shocker: 'left-[28.27%] top-[65.16%]',
    'battering ram': 'left-[52.54%] top-[64.88%]',
    kraken: 'left-[72.17%] top-[64.88%]',
    maniac: 'left-[40.58%] top-[86.36%]',
